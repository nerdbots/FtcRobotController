...
public class PurePursuitRobotMovement4 {
...
//    static final double DISTANCE_THRESHOLD = 2;
    ...
    public PurePursuitRobotMovement4(LinearOpMode opmode) {
        this.opmode = opmode;
...
//            }
        ...
        double relativeTurnAngle = MathFunctions.AngleWrapDeg(robotAngleToTarget - 90 - getAngle());
