...
//        Lower arm and release wobble goal
        ...
        allPoints.add(new CurvePoint(-12, 116, 1.0, 0.4, 40, 0, 0.3));
        allPoints.add(new CurvePoint(21, 100, 1.0, 0.4, 40, 180, 0.3));
        allPoints.add(new CurvePoint(21, 28, 1.0, 0.4, 40, 180, 0.3));
        allPoints.add(new CurvePoint(21, -44, 1.0, 0.3, 40, 180, 0.3));
...
//        Lower arm and release wobble goal
        ...
        allPoints.add(new CurvePoint(6, 60, 1.0, 0.4, 40, 180, 0.3));
